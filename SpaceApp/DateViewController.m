...

{
    ...
    double angleMercury = [Math calculateAngleX:self.mercury.x Y:self.mercury.y];
    ...
    double angleVenus = [Math calculateAngleX:self.venus.x Y:self.venus.y];
    ...
    double angleEarth = [Math calculateAngleX:self.earth.x Y:self.earth.y];
    ...
    double angleMars = [Math calculateAngleX:self.mars.x Y:self.mars.y];
    ...
    double angleJupiter = [Math calculateAngleX:self.jupiter.x Y:self.jupiter.y];
    ...
    double angleSaturn = [Math calculateAngleX:self.saturn.x Y:self.saturn.y];
    ...
    double angleUranus = [Math calculateAngleX:self.uranus.x Y:self.uranus.y];
    ...
    double angleNeptune = [Math calculateAngleX:self.neptune.x Y:self.neptune.y];
...
//    self.mercury.graphDistance = [[PlanetInfo distances[[@"mercury"] integerValue]];
//                                   
//    self.venus.graphDistance = [PlanetInfo distances[[@"venus"] integerValue];
//    self.earth.graphDistance = [PlanetInfo distances[[@"earth"] integerValue];
//    self.mars.graphDistance = [PlanetInfo distances[[@"mars"] integerValue];
//    self.jupiter.graphDistance = [PlanetInfo distances[[@"jupiter"] integerValue];
//    self.saturn.graphDistance = [PlanetInfo distances[[@"saturn"] integerValue];
//    self.uranus.graphDistance = [PlanetInfo distances[[@"uranus"] integerValue];
//    self.neptune.graphDistance = [PlanetInfo distances[[@"neptune"] integerValue];
