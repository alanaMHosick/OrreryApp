...
{
    return @[@"nasa_dawn_large2.png",@"nasa_dawn_medium.png",@"nasa_dawn_small.png"];
}
...
+ (CGRect ) atmosphereStringLabel1:(UIView *)view
{
    ...
    CGRect rect;
    if (viewRectT.size.width == 320){
        if (rect.size.height > 560){
            rect = CGRectMake(12,200,280,40);
            return rect;
        }else{
            rect = CGRectMake(12,160,280,40);
            return rect;
        }
    }else{
...
+ (CGRect ) atmosphereStringLabel2:(UIView *)view
{
    ...
    if (viewRectT.size.width == 320){
        if (rect.size.height > 560){
            rect = CGRectMake(12,230,280,40);
            return rect;
        }else{
        rect = CGRectMake(12,190,280,40);
        return rect;
            }
    }else{
...
+ (CGRect ) atmosphereLabel:(UIView *)view
{
    ...
    if (viewRectT.size.width == 320){
        if (rect.size.height > 560){
            rect = CGRectMake(12,275,280,50);
            return rect;
        }else{
        rect = CGRectMake(12,235,280,50);
        return rect;
        }
    }else{
...
+ (CGRect ) dateLabel:(UIView *)view
{
    CGRect viewRectT = [view bounds];
    CGRect rect;
    NSLog(@"%f", viewRectT.size.height);
    if (viewRectT.size.width == 320){
        if (rect.size.height > 560){
            rect = CGRectMake(12,490,280,40);
            return rect;
        }else{
